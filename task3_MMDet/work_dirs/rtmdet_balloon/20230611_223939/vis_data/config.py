...
log_level = 'INFO'
load_from = 'work_dirs/rtmdet_balloon/epoch_30.pth'
resume = False
train_cfg = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='balloon_dataset/balloon/',
        ann_file='train/balloon_train_coco.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='balloon_dataset/balloon/',
        ann_file='val/balloon_val_coco.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='balloon_dataset/balloon/val/balloon_val_coco.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
